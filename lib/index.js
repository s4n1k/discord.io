 ...
 * @arg {Number} [input.since] - Not needed and can be ignored
 * @arg {Boolean} [input.afk] - Also probably not needed
 * 
...
DCP.setPresence = function(input) {
		var payload = Events.SET_PRESENCE(
			input.status,
			type(input.game) === 'object' ? {
